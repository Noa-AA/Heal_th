...
public class ChatIntroPaging {
	...
	public ChatIntroPaging() {}

	
	public ChatIntroPaging(int totalCount, int curPage) {
	...
	public ChatIntroPaging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
