...
public class StorePaging {
	...
	public StorePaging(int totalCount, int curPage) {
	...
	public StorePaging(int totalCount) {
		setTotalCount(totalCount);
		
		makePaging();
	}
	
	public StorePaging(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public StorePaging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);	//화면에 보여질 게시글 개수 지정하기
