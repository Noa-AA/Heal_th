...
public class AdminWithDrawPaging {
	...
	public AdminWithDrawPaging() {}

	
	public AdminWithDrawPaging(int totalCount, int curPage) {
	...
	public AdminWithDrawPaging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
