...
public class SaebyeolPaging {
	...
	public SaebyeolPaging() {}

	
	public SaebyeolPaging(int totalCount, int curPage) {
	...
	public SaebyeolPaging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
