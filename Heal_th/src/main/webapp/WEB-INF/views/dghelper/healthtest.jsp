	...
	<div class="question-container">
		...
		<div class="resultEF" style="display: none;">
			<div id="result1" style="display: none;">
				<div class="resultImg"><img src="/resources/img/dgtest/result1.png"></div>
				<div class="mbti-content">
					<p>크로스핏</p>
			...
			<div class="resultImg"><img src="/resources/img/dgtest/result2.png"></div>
				<div class="mbti-content">
					<p>줌바</p>
					<p>▶ 나와 찰떡궁합 운동은?</p>
			...
			<div class="resultImg"><img src="/resources/img/dgtest/result3.png"></div>
				<div class="mbti-content">
					<p>동호회 활동</p>
					<p>▶ 나와 찰떡궁합 운동은?</p>
			...
			<div class="resultImg"><img src="/resources/img/dgtest/result4.png"></div>
				<div><img src=""></div>
				<div class="mbti-content">
					<p>러닝크루</p>
					<p>▶ 나와 찰떡궁합 운동은?</p>
		...
		<div class="resultET" style="display: none;">
			...
			<div class="resultImg"><img src="/resources/img/dgtest/result5.png"></div>
				<div class="mbti-content">
					<p>폴댄스</p>
					<p>▶ 나와 찰떡궁합 운동은?</p>
			...
			<div class="resultImg"><img src="/resources/img/dgtest/result6.png"></div>
				<div class="mbti-content">
					<p>VR운동</p>
					<p>▶ 나와 찰떡궁합 운동은?</p>
					<p>운동을 끊으면 길어야 한 달.</p>
			...
			<div class="resultImg"><img src="/resources/img/dgtest/result7.png"></div>
				<div class="mbti-content">
					<p>테니스</p>
					<p>▶ 나와 찰떡궁합 운동은?</p>
			...
			<div class="resultImg"><img src="/resources/img/dgtest/result8.png"></div>
				<div class="mbti-content">
					<p>복싱</p>
					<p>▶ 나와 찰떡궁합 운동은?</p>
		...
		<div class="resultIF" style="display: none;">
			...
			<div class="resultImg"><img src="/resources/img/dgtest/result9.png"></div>
				<div class="mbti-content">
					<p>클라이밍</p>
					<p>▶ 나와 찰떡궁합 운동은?</p>
			...
			<div class="resultImg"><img src="/resources/img/dgtest/result10.png"></div>
				<div class="mbti-content">
					<p>필록싱</p>
					<p>▶ 나와 찰떡궁합 운동은?</p>
			...
			<div class="resultImg"><img src="/resources/img/dgtest/result11.png"></div>
				<div class="mbti-content">
					<p>요가</p>
					<p>▶ 나와 찰떡궁합 운동은?</p>
			...
			<div class="resultImg"><img src="/resources/img/dgtest/result12.png"></div>
				<div class="mbti-content">
					<p>라이딩</p>
					<p>▶ 나와 찰떡궁합 운동은?</p>
		...
		<div class="resultIT" style="display: none;">
			...
			<div class="resultImg"><img src="/resources/img/dgtest/result13.png"></div>
				<div class="mbti-content">
					<p>클레이사격</p>
					<p>▶ 나와 찰떡궁합 운동은?</p>
			...
			<div class="resultImg"><img src="/resources/img/dgtest/result14.png"></div>
				<div class="mbti-content">
					<p>EMS트레이닝</p>
					<p>▶ 나와 찰떡궁합 운동은?</p>
			...
			<div class="resultImg"><img src="/resources/img/dgtest/result15.png"></div>
				<div class="mbti-content">
					<p>수영</p>
					<p>▶ 나와 찰떡궁합 운동은?</p>
					<p>즉흥적인 것은 극혐.</p>
					<p>계획을 짜고 그 테두리 안에서 움직이는 걸 좋아하는 타입이라 반복적, 규칙적인 스포츠가 적합해요.</p>
		...
		<div id="question-footer"><img src="/resources/img/logo_purple.png"></div>
