...
<div>
   	<a href="/board/dietBoard" id="totalList" name="totalList" style="float: left; margin-top: -25px;">전체 게시글 보기 ▼</a>
</div>
...
<c:forEach items="${boardSearch }" var="boardSearch">
	<ul id="searchResult" style="list-style: none;">
		<li style="float: left; display: none;" >${boardSearch.dietNo }</li>
		<li style="display:  -webkit-inline-box; inline-size: -webkit-fill-available; line-height: 3;"><a href="${path}/board/dView?dietNo=${boardSearch.dietNo}" id="boardUrl">${boardSearch.dTitle }</a></li><br>
		<li style="display:  -webkit-inline-box; inline-size: -webkit-fill-available; line-height: 3;" class="ellipsis" >${boardSearch.dContent }</li><br>
		
		<li style="float: right;">
		
			<c:set var="fileSto" value="${null }"/>
			<c:forEach items="${fileMapList }" var="fileMap">
			<c:if test="${fileMap.dietNo eq boardSearch.dietNo}">
		...
		<li style="float: left; margin-right: 8px;" >작성일 <fmt:formatDate value="${boardSearch.dInstDate }" pattern="yy-MM-dd"/></li>
		<li style="float: left; margin-right: 8px;" >|</li>
		<li style="float: left; margin-right: 8px;" >조회수 ${boardSearch.dHit }</li>
		<li style="float: left; margin-right: 8px;" >|</li>
		<li style="float: left;">좋아요 ${boardSearch.dThumbs }</li><br>
	</ul>
</c:forEach>
