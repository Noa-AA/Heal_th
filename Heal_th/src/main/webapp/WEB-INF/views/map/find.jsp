...
#menu_wrap {position:absolute;top:15px;left:0;bottom:0;width:250px; height: 595px;margin:10px 0 30px 10px;padding:5px;overflow-y:auto;background:rgba(220, 220, 220, 0.7);z-index: 1;font-size:12px;border-radius: 10px;}
